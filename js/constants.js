...
export const BIOME_TARGET = [
  ...
  [B('plains',0.5), B('plains',0.5), B('plains',0.5), B('plains',0.5), B('plains',0.5), B('desert',0.5), B('desert',0.5), B('desert',0.5), B('plains',1.0), B('plains',1.0), B('plains',0.9), B('water',0.9), B('mushroom',0.6), B('mushroom',0.6), B('mushroom',0.7), B('water',1.0)],
  [B('plains',0.5), B('plains',0.5), B('plains',0.5), B('plains',0.5), B('desert',0.5), B('desert',0.5), B('desert',0.6), B('desert',0.6), B('plains',0.5), B('plains',1.0), B('plains',0.9), B('water',1.0), B('mushroom',0.9), B('mushroom',0.6), B('mushroom',0.9), B('water',0.9)],
  [B('plains',0.5), B('plains',0.5), B('desert',0.5), B('desert',0.6), B('desert',0.7), B('desert',0.7), B('desert',0.7), B('desert',0.6), B('plains',0.6), B('water',0.2), B('plains',0.2), B('mushroom',0.8), B('mushroom',0.9), B('mushroom',0.6), B('mushroom',0.9), B('water',0.9)],
  [B('plains',0.5), B('desert',0.5), B('desert',0.6), B('desert',0.7), B('desert',0.7), B('desert',0.8), B('desert',0.8), B('desert',0.7), B('desert',0.7), B('water',0.2), B('water',0.4), B('mushroom',0.8), B('mushroom',0.9), B('mushroom',0.6), B('mushroom',0.9), B('water',1.0)],
