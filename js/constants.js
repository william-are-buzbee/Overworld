...
export const BIOME_TARGET = [
  ...
  [B('ocean',1.0,0.2), B('shallows',1.0,0.2), B('plains',0.5,0.6), B('plains',0.8,0.6), B('plains',0.8,0.6), B('fungal',0.7,0.7), B('fungal',1.0,0.2), B('plains',0.5,0.6), B('plains',0.5,0.6), B('shallows',1.0,0.5), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2)],
  [B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('shallows',1.0,0.2), B('plains',0.5,0.6), B('fungal',0.7,0.8), B('fungal',0.9,0.2), B('fungal',1.0,0.2), B('fungal',0.7,0.2), B('plains',0.5,0.6), B('shallows',1.0,0.5), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2), B('ocean',1.0,0.2)],
