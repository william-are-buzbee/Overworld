...
export const BIOME_TARGET = [
  ...
  [B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0), B('water',0.1), B('plains',0.1), B('plains',0.2), B('water',0.1), B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0), B('water',1.0)],
